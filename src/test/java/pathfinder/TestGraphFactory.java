...
public class TestGraphFactory {
    public static void main(String[] args) {
        ...
        //pathFinder.findPath(new Coord(0.000000,0.000000), new Coord(-0.011000,0.011000)); //Negro
        System.out.println("------------------------");
        pathFinder.findPath(new Coord(0.000000,0.000000), new Coord(0.02,0.0)); //Negro => Verde (CON EL GRAFO PEQUEÑO)
        System.out.println("------------------------");
//        pathFinder.findPath(new Coord(-0.002000,0.010000), new Coord(-0.014000,0.014000)); //Rojo
//        System.out.println("------------------------");
//        pathFinder.findPath(new Coord(0.0,-0.007), new Coord(-0.015,0.015000)); //Verde => Negro
//        System.out.println("------------------------");
//        pathFinder.findPath(new Coord(0.0,0.014), new Coord(-0.016,-0.01)); //Azul
//        System.out.println("------------------------");
//        pathFinder.findPath(new Coord(0.0,-0.002), new Coord(-0.0075,0.012)); //Azul
//        System.out.println("------------------------");
//        pathFinder.findPath(new Coord(-0.004,0.013), new Coord(0.002,-0.009000));
    }
    ...
    public static Graph getTestGraph() {
        ...
        return new Graph(busStops, busRoutes);
    }
